...
clippy.Agent.prototype = {
    ...
    show:function (fast) {
        ...
        if (this._el.css('right') === "" && this._el.css('bottom') === "" &&
            (this._el.css('top') === 'auto' || !this._el.css('left') === 'auto')
          )
        {
    ...
    _position:function (side) {
        ...
        switch (side) {
            case 'top-left':
                ...
                top = $(this._targetEl).position().top - bH - this._BALLOON_MARGIN - 40;
                break;
            case 'top-right':
        ...
        this._balloon.css({top:top, left:left, height:"4em"});
